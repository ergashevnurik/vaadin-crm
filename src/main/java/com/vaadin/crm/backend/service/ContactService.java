...
import com.vaadin.crm.backend.repository.CompanyRepository;
import com.vaadin.crm.backend.repository.ContactRepository;
...
public class ContactService {
    ...
    public void save(Contact contact) {
        if (contact == null) {
            LOGGER.log(Level.SEVERE, "Contact is null. Are you sure you have connected your from to the application?");
    ...
    public void populateTestData() {
        if (companyRepository.count() == 0) {
            companyRepository.saveAll(
                    Stream.of("MENZ", "Acinonyx Soft", "Menz Clothing")
                            .map(Company::new)
